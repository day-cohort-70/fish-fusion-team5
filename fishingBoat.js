...
Data structure will be an array of objects named fish array
...
The function will be called boatInventory. 
When the function is invoked it will return the array of fish objects 

CODEENGLISH:

const boatInventory = (item in the array)=> {
-Species
    -Weight
    -Price 
    -Amount
...
( go back and compair notes for the bug rangler)
